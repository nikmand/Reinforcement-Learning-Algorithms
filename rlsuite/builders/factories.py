...
def dqn_agent_factory(dqn_agent, network, criterion, optimizer, num_of_actions, gamma, eps_decay, eps_start, eps_end):
    """  """
    ...
    agent = agent_algorithm(num_of_actions, network, criterion, optimizer, gamma, eps_decay, eps_start, eps_end)

    return agent


def memory_factory(mem_type, mem_size):
    """  """
